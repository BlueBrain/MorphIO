...
def test_mut_immut_have_same_methods():
    ...
    only_in_immut = {'section_types', 'diameters', 'perimeters', 'points', 'annotations'}
    only_in_mut = {'write', 'append_section', 'delete_section', 'build_read_only'}
