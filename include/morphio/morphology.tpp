...
TMorphology<SectionT>::TMorphology(const HighFive::Group& group, unsigned int options)
    : TMorphology<SectionT>(readers::h5::load(group), options) {}

template <typename SectionT>
TMorphology<SectionT>::TMorphology(const std::string& source, unsigned int options)
    : TMorphology<SectionT>(loadURI(source, options), options) {}
...
template <typename SectionT>
TMorphology<SectionT>::TMorphology(TMorphology<SectionT>&&) noexcept = default;
