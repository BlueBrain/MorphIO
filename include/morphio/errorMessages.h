...
public:
    ...
    **/
    ...
    const std::string ERROR_MULTIPLE_SOMATA(const std::vector<Sample>& somata) const;
    ...
    const std::string ERROR_REPEATED_ID(const Sample& originalSample, const Sample& newSample) const;
