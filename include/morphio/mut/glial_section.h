...
class GlialSection: public std::enable_shared_from_this<GlialSection>
{
  public:
    ...
    **/
    ...
    std::shared_ptr<GlialSection> appendSection(const morphio::GlialSection&, bool recursive = false);
  ...
  private:
    ...
    GlialSection(GlialCell*, unsigned int id, const morphio::GlialSection& section);
