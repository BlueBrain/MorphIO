...
namespace boost
{
    ...
    inline std::string lexical_cast( const brion::MeshStructure& f )
    {
        switch( f )
        {
        case brion::MESH_SPINES: return "spines";
        case brion::MESH_BOUTONS: return "boutons";
        case brion::MESH_PSD: return "post_synaptic_densities";
        case brion::MESH_AZ: return "active_zones";
        case brion::MESH_ENDO: return "endoplasmic_reticulum";
        default:
...
public:
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/mappings/vertex/section_ids" );
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/mappings/vertex/relative_positions" );
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/triangles/soup" );
        return _numElements( dataset );
    }
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/mappings/triangle/section_ids" );
        uint16_tsPtr buffer( new uint16_ts );
        buffer->resize( _numElements( dataset ));
        dataset.read( buffer->data(), H5::PredType::STD_U32LE );
        return buffer;
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet ("/membrane/mesh/mappings/triangle/relative_positions" );
        floatsPtr buffer( new floats );
        buffer->resize( _numElements( dataset ));
        dataset.read( buffer->data(), H5::PredType::IEEE_F32LE );
        return buffer;
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/triangles/strip" );
        return _numElements( dataset );
    }
    ...
    {
        const H5::DataSet& dataset = _file.openDataSet( "/membrane/mesh/normals" );
        return _numElements( dataset );
    }
